...
gym.register(
    id="Isaac-M1-Panda-Wbc-Teacher-C0-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-M1-Panda-Residual-Wbc-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "go2_pvcnn.tasks.m1_panda_wbc_roll_teacher_env_cfg:M1PandaWbcRollTeacherEnvCfg",
...
gym.register(
    id="Isaac-M1-Panda-ArmMpc-Residual-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "go2_pvcnn.tasks.m1_panda_arm_mpc_residual_env_cfg:M1PandaArmMpcResidualEnvCfg",
        "rsl_rl_cfg_entry_point": None,
    },
)

gym.register(
    id="Isaac-M1-Panda-Student-S1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "go2_pvcnn.tasks.m1_panda_student_s1_env_cfg:M1PandaStudentS1EnvCfg",
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    id="Isaac-M1-Panda-Folded-Load-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "go2_pvcnn.tasks.m1_panda_folded_load_env_cfg:M1PandaFoldedLoadEnvCfg",
        "rsl_rl_cfg_entry_point": None,
    },
)
...
print("[go2_pvcnn]   - Isaac-M1-Panda-Residual-Wbc-v0")
print("[go2_pvcnn]   - Isaac-M1-Panda-ArmMpc-Residual-v0")
