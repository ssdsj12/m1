...
- GPU0 8×16 zero-action probing passes, but the full 8×256 horizon reaches `-0.10324 rad` joint margin. Smoke and long training therefore remain stopped; see the [PD retune GPU log](../log/2026-08-25-m1-panda-folded-load-pd-retune-gpu.md).
