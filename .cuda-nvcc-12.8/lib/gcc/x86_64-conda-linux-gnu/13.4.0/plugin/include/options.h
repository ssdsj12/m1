...
#define OPTION_MASK_ISA2_AVX5124FMAPS (HOST_WIDE_INT_1U << 5)
#define OPTION_MASK_ISA2_AVX5124VNNIW (HOST_WIDE_INT_1U << 6)
#define OPTION_MASK_ISA2_AVX512BF16 (HOST_WIDE_INT_1U << 7)
...
#define OPTION_MASK_ISA2_AVX512FP16 (HOST_WIDE_INT_1U << 8)
...
#define OPTION_MASK_ISA2_AVX512VP2INTERSECT (HOST_WIDE_INT_1U << 9)
#define OPTION_MASK_ISA_AVX512VPOPCNTDQ (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_ISA2_AVXIFMA (HOST_WIDE_INT_1U << 10)
#define OPTION_MASK_ISA2_AVXNECONVERT (HOST_WIDE_INT_1U << 11)
#define OPTION_MASK_ISA2_AVXVNNI (HOST_WIDE_INT_1U << 12)
#define OPTION_MASK_ISA2_AVXVNNIINT8 (HOST_WIDE_INT_1U << 13)
...
#define OPTION_MASK_ISA2_CLDEMOTE (HOST_WIDE_INT_1U << 14)
#define OPTION_MASK_ISA_CLFLUSHOPT (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_ISA_CLWB (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_ISA2_CLZERO (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_ISA2_CMPCCXADD (HOST_WIDE_INT_1U << 16)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_ISA2_CX16 (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_ISA2_ENQCMD (HOST_WIDE_INT_1U << 18)
...
#define OPTION_MASK_ISA2_HLE (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_ISA2_HRESET (HOST_WIDE_INT_1U << 20)
...
#define OPTION_MASK_ISA2_KL (HOST_WIDE_INT_1U << 21)
...
#define OPTION_MASK_ISA2_MOVBE (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_ISA2_MOVDIR64B (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_ISA_MOVDIRI (HOST_WIDE_INT_1U << 37)
#define MASK_MS_BITFIELD_LAYOUT (1U << 18)
#define OPTION_MASK_ISA2_MWAIT (HOST_WIDE_INT_1U << 24)
#define OPTION_MASK_ISA2_MWAITX (HOST_WIDE_INT_1U << 25)
...
#define OPTION_MASK_ISA2_PCONFIG (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_ISA_PKU (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_ISA2_PREFETCHI (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_ISA_PREFETCHWT1 (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_ISA2_PTWRITE (HOST_WIDE_INT_1U << 28)
#define OPTION_MASK_ISA2_RAOINT (HOST_WIDE_INT_1U << 29)
#define OPTION_MASK_ISA2_RDPID (HOST_WIDE_INT_1U << 30)
...
#define OPTION_MASK_ISA2_SERIALIZE (HOST_WIDE_INT_1U << 31)
#define OPTION_MASK_ISA2_SGX (HOST_WIDE_INT_1U << 32)
...
#define OPTION_MASK_ISA2_TSXLDTRK (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_ISA2_UINTR (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_ISA2_VAES (HOST_WIDE_INT_1U << 35)
#define MASK_VECT8_RETURNS (1U << 29)
#define OPTION_MASK_ISA_VPCLMULQDQ (HOST_WIDE_INT_1U << 57)
#define MASK_VZEROUPPER (1U << 30)
#define OPTION_MASK_ISA2_WAITPKG (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_ISA2_WBNOINVD (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_ISA2_WIDEKL (HOST_WIDE_INT_1U << 38)
...
#endif
#if defined(HOST_BITS_PER_WIDE_INT) && 39 > HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT__param_uninit_max_chain_len_ = 325,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 326,   /* --param=uninit-max-num-chains= */
  OPT__param_uninlined_function_insns_ = 327,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 328, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 329,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 330,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 331,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 332,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 333,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 334,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 335,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 336,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_induction_float_ = 337,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 338,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 339,/* --param=vect-max-layout-candidates= */
  ...
  OPT__param_x86_stlf_window_ninsns_ = 344,  /* --param=x86-stlf-window-ninsns= */
  OPT__param_x86_stv_max_visits_ = 345,      /* --param=x86-stv-max-visits= */
  ...
  OPT_Wanalyzer_allocation_size = 455,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 456,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 457,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 458,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 459,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 460,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 461,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 462,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 463,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 464,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 465,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 466,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 467,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 468,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 469,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 470,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_recursion = 471,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 472,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 473,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 474,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 475,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 476,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 477,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_possible_null_argument = 478,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 479,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 480,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 481,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 482,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 483,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 484,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 485,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 486,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 487,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 488,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 489,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 490,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 491,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 492,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 493,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 494,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 495,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 496,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 497,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 498,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 499,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 500,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 501,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 502,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 503, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 504,                  /* -Warray-bounds= */
  OPT_Warray_compare = 505,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 506, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 507,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 508,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 509,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 510, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 511,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 512,              /* -Wattribute-warning */
  OPT_Wattributes = 513,                     /* -Wattributes */
  OPT_Wattributes_ = 514,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 515,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 516, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 517,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 518,                   /* -Wbool-compare */
  OPT_Wbool_operation = 519,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 520,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 521,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 522,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 523, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 524,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 525,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 526,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 527,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 528,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 529,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 530, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 531,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 532,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 533,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 534, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 535,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 536,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 537,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 538,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 539,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 540,                      /* -Wcase-enum */
  OPT_Wcast_align = 541,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 542,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 543,             /* -Wcast-function-type */
  OPT_Wcast_qual = 544,                      /* -Wcast-qual */
  OPT_Wcast_result = 545,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 546, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 547,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 548,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 549,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 550,           /* -Wcharacter-truncation */
  OPT_Wchkp = 551,                           /* -Wchkp */
  OPT_Wclass_conversion = 552,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 553,                /* -Wclass-memaccess */
  OPT_Wclobbered = 554,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 555,                /* -Wcomma-subscript */
  OPT_Wcomment = 556,                        /* -Wcomment */
  /* OPT_Wcomments = 557, */                 /* -Wcomments */
  OPT_Wcompare_reals = 558,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 559,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 560,        /* -Wconditionally-supported */
  OPT_Wconversion = 561,                     /* -Wconversion */
  OPT_Wconversion_extra = 562,               /* -Wconversion-extra */
  OPT_Wconversion_null = 563,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 564,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 565,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 566,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 567,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 568,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 569,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 570, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 571,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 572,             /* -Wdangling-reference */
  OPT_Wdate_time = 573,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 574,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 575,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 576,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 577,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 578,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 579,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 580,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 581,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 582,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 583,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 584,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 585,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 586,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 587,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 588,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 589,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 590,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 591,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 592,                /* -Wduplicated-cond */
  OPT_Weffc__ = 593,                         /* -Weffc++ */
  OPT_Wempty_body = 594,                     /* -Wempty-body */
  OPT_Wendif_labels = 595,                   /* -Wendif-labels */
  OPT_Wenum_compare = 596,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 597,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 598,              /* -Wenum-int-mismatch */
  OPT_Werror = 599,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 600, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 601,                         /* -Werror= */
  OPT_Wexceptions = 602,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 603,           /* -Wexpansion-to-defined */
  OPT_Wextra = 604,                          /* -Wextra */
  OPT_Wextra_semi = 605,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 606,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 607,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 608,                    /* -Wfloat-equal */
  /* OPT_Wformat = 609, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 610,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 611,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 612,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 613,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 614, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 615,               /* -Wformat-overflow= */
  OPT_Wformat_security = 616,                /* -Wformat-security */
  OPT_Wformat_signedness = 617,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 618, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 619,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 620,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 621,             /* -Wformat-zero-length */
  OPT_Wformat_ = 622,                        /* -Wformat= */
  OPT_Wframe_address = 623,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 624,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 625,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 626,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 627,           /* -Wfunction-elimination */
  /* OPT_Whsa = 628, */                      /* -Whsa */
  OPT_Wif_not_aligned = 629,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 630,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 631,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 632,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 633, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 634,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 635,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 636,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 637,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 638,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 639, */                   /* -Wimport */
  OPT_Winaccessible_base = 640,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 641,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 642,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 643,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 644,             /* -Winit-list-lifetime */
  OPT_Winit_self = 645,                      /* -Winit-self */
  OPT_Winline = 646,                         /* -Winline */
  OPT_Wint_conversion = 647,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 648,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 649,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 650,               /* -Winteger-division */
  OPT_Winterference_size = 651,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 652,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 653,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 654,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 655,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 656,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 657,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 658,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 659,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 660,               /* -Wjump-misses-init */
  OPT_Wl_ = 661,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 662, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 663,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 664,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 665,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 666,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 667,                     /* -Wlogical-op */
  OPT_Wlong_long = 668,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 669,              /* -Wlto-type-mismatch */
  OPT_Wmain = 670,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 671,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 672,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 673,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 674,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 675,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 676,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 677,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 678,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 679,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 680,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 681,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 682,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 683, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 684,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 685, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 686,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 687,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 688,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 689,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 690,       /* -Wmissing-template-keyword */
  OPT_Wmudflap = 691,                        /* -Wmudflap */
  OPT_Wmultichar = 692,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 693,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 694,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 695,                     /* -Wnamespaces */
  OPT_Wnarrowing = 696,                      /* -Wnarrowing */
  OPT_Wnested_externs = 697,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 698, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 699, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 700, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 701, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 702, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 703, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 704,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 705,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 706,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 707,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 708,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 709,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 710, */               /* -Wnormalized */
  OPT_Wnormalized_ = 711,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 712,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 713,                /* -Wobjc-root-class */
  OPT_Wodr = 714,                            /* -Wodr */
  OPT_Wold_style_cast = 715,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 716,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 717,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 718,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 719,                    /* -Wopenmp-simd */
  OPT_Woverflow = 720,                       /* -Woverflow */
  OPT_Woverlength_strings = 721,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 722, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 723,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 724,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 725,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 726,            /* -Woverwrite-recursive */
  OPT_Wp_ = 727,                             /* -Wp, */
  OPT_Wpacked = 728,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 729,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 730,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 731,                         /* -Wpadded */
  OPT_Wparentheses = 732,                    /* -Wparentheses */
  OPT_Wpedantic = 733,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 734,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 735,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 736,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 737, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 738,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 739,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 740,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 741,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 742,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 743,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 744,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 745,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 746,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 747,                       /* -Wprotocol */
  OPT_Wpsabi = 748,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 749,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 750,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 751,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 752,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 753,                /* -Wredundant-decls */
  OPT_Wredundant_move = 754,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 755,                 /* -Wredundant-tags */
  OPT_Wregister = 756,                       /* -Wregister */
  OPT_Wreorder = 757,                        /* -Wreorder */
  OPT_Wrestrict = 758,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 759,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 760,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 761,           /* -Wscalar-storage-order */
  OPT_Wselector = 762,                       /* -Wselector */
  OPT_Wself_move = 763,                      /* -Wself-move */
  OPT_Wsequence_point = 764,                 /* -Wsequence-point */
  OPT_Wshadow = 765,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 766, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 767,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 768, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 769,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 770, */            /* -Wshadow=global */
  OPT_Wshadow_local = 771,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 772,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 773,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 774,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 775, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 776,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 777,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 778,                /* -Wsign-conversion */
  OPT_Wsign_promo = 779,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 780,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 781,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 782,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 783,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 784,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 785,                    /* -Wspeculative */
  OPT_Wstack_protector = 786,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 787,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 788,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 789,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 790,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 791,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 792,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 793,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 794,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 795,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 796,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 797, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 798,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 799,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 800,            /* -Wstringop-truncation */
  OPT_Wstyle = 801,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 802,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 803,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 804,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 805,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 806,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 807,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 808,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 809,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 810,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 811,               /* -Wsuggest-override */
  OPT_Wsurprising = 812,                     /* -Wsurprising */
  OPT_Wswitch = 813,                         /* -Wswitch */
  OPT_Wswitch_bool = 814,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 815,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 816,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 817,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 818,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 819,                      /* -Wsync-nand */
  OPT_Wsynth = 820,                          /* -Wsynth */
  OPT_Wsystem_headers = 821,                 /* -Wsystem-headers */
  OPT_Wtabs = 822,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 823,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 824,           /* -Wtautological-compare */
  OPT_Wtemplates = 825,                      /* -Wtemplates */
  OPT_Wterminate = 826,                      /* -Wterminate */
  OPT_Wtraditional = 827,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 828,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 829,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 830,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 831,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 832,                           /* -Wtsan */
  OPT_Wtype_limits = 833,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 834,            /* -Wundeclared-selector */
  OPT_Wundef = 835,                          /* -Wundef */
  OPT_Wundefined_do_loop = 836,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 837,                      /* -Wunderflow */
  OPT_Wunicode = 838,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 839,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 840,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 841,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 842,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 843, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 844, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 845,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 846,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 847,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 848,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 849, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 850,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 851,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 852,                /* -Wunused-function */
  OPT_Wunused_label = 853,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 854,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 855,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 856,               /* -Wunused-parameter */
  OPT_Wunused_result = 857,                  /* -Wunused-result */
  OPT_Wunused_value = 858,                   /* -Wunused-value */
  OPT_Wunused_variable = 859,                /* -Wunused-variable */
  OPT_Wuse_after_free = 860,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 861,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 862,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 863,                   /* -Wuseless-cast */
  OPT_Wvarargs = 864,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 865,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 866,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 867,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 868,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 869,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 870,            /* -Wvirtual-move-assign */
  OPT_Wvla = 871,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 872,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 873,                  /* -Wvla-parameter */
  OPT_Wvolatile = 874,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 875,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 876,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 877,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 878,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 879,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 880,                       /* -Wzerotrip */
  OPT_X = 881,                               /* -X */
  OPT_Xassembler = 882,                      /* -Xassembler */
  OPT_Xf = 883,                              /* -Xf */
  OPT_Xlinker = 884,                         /* -Xlinker */
  OPT_Xpreprocessor = 885,                   /* -Xpreprocessor */
  OPT_Z = 886,                               /* -Z */
  OPT_ansi = 887,                            /* -ansi */
  OPT_aux_info = 888,                        /* -aux-info */
  /* OPT_aux_info_ = 889, */                 /* -aux-info= */
  OPT_c = 890,                               /* -c */
  OPT_callgraph = 891,                       /* -callgraph */
  OPT_coverage = 892,                        /* -coverage */
  OPT_cpp = 893,                             /* -cpp */
  OPT_cpp_ = 894,                            /* -cpp= */
  OPT_d = 895,                               /* -d */
  OPT_debuglib_ = 896,                       /* -debuglib= */
  OPT_defaultlib_ = 897,                     /* -defaultlib= */
  OPT_defined_only = 898,                    /* -defined-only */
  OPT_demangle = 899,                        /* -demangle */
  OPT_dstartfiles = 900,                     /* -dstartfiles */
  OPT_dump_body_ = 901,                      /* -dump-body= */
  OPT_dump_level_ = 902,                     /* -dump-level= */
  OPT_dumpbase = 903,                        /* -dumpbase */
  OPT_dumpbase_ext = 904,                    /* -dumpbase-ext */
  OPT_dumpdir = 905,                         /* -dumpdir */
  OPT_dumpfullversion = 906,                 /* -dumpfullversion */
  OPT_dumpmachine = 907,                     /* -dumpmachine */
  OPT_dumpspecs = 908,                       /* -dumpspecs */
  OPT_dumpversion = 909,                     /* -dumpversion */
  OPT_e = 910,                               /* -e */
  OPT_export_dynamic = 911,                  /* -export-dynamic */
  OPT_fPIC = 912,                            /* -fPIC */
  OPT_fPIE = 913,                            /* -fPIE */
  OPT_fRTS_ = 914,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 915,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 916,                   /* -fabi-version= */
  OPT_faccess_control = 917,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 918,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 919,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 920,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 921,                  /* -falign-commons */
  OPT_falign_functions = 922,                /* -falign-functions */
  OPT_falign_functions_ = 923,               /* -falign-functions= */
  OPT_falign_jumps = 924,                    /* -falign-jumps */
  OPT_falign_jumps_ = 925,                   /* -falign-jumps= */
  OPT_falign_labels = 926,                   /* -falign-labels */
  OPT_falign_labels_ = 927,                  /* -falign-labels= */
  OPT_falign_loops = 928,                    /* -falign-loops */
  OPT_falign_loops_ = 929,                   /* -falign-loops= */
  /* OPT_faligned_new = 930, */              /* -faligned-new */
  OPT_faligned_new_ = 931,                   /* -faligned-new= */
  OPT_fall_instantiations = 932,             /* -fall-instantiations */
  OPT_fall_intrinsics = 933,                 /* -fall-intrinsics */
  OPT_fall_virtual = 934,                    /* -fall-virtual */
  OPT_fallocation_dce = 935,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 936,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 937,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 938,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 939, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 940,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 941,         /* -falt-external-templates */
  OPT_fanalyzer = 942,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 943,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 944,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 945,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 946,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 947,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 948,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 949,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 950,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 951,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 952,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 953,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 954, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 955,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 956, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 957, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 958, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 959, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 960,            /* -fasan-shadow-offset= */
  OPT_fasm = 961,                            /* -fasm */
  OPT_fassert = 962,                         /* -fassert */
  OPT_fassociative_math = 963,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 964,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 965,                   /* -fauto-inc-dec */
  OPT_fauto_init = 966,                      /* -fauto-init */
  OPT_fauto_profile = 967,                   /* -fauto-profile */
  OPT_fauto_profile_ = 968,                  /* -fauto-profile= */
  OPT_fautomatic = 969,                      /* -fautomatic */
  OPT_fbackslash = 970,                      /* -fbackslash */
  OPT_fbacktrace = 971,                      /* -fbacktrace */
  OPT_fbit_tests = 972,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 973,             /* -fblas-matmul-limit= */
  OPT_fbounds = 974,                         /* -fbounds */
  OPT_fbounds_check = 975,                   /* -fbounds-check */
  OPT_fbounds_check_ = 976,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 977,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 978,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 979, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 980, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 981, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 982,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 983,           /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 984,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 985,                        /* -fbuiltin */
  OPT_fbuiltin_ = 986,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 987,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 988,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 989,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 990,                    /* -fcall-saved- */
  OPT_fcall_used_ = 991,                     /* -fcall-used- */
  OPT_fcaller_saves = 992,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 993,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 994,                /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 995,               /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 996,       /* -fcanonical-system-headers */
  OPT_fcase = 997,                           /* -fcase */
  /* OPT_fcf_protection = 998, */            /* -fcf-protection */
  OPT_fcf_protection_ = 999,                 /* -fcf-protection= */
  OPT_fchar8_t = 1000,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1001,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1002, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1003,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1004,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1005,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1006, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1007, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1008, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1009, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1010, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1011, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1012,                  /* -fcheckaction= */
  OPT_fchecking = 1013,                      /* -fchecking */
  OPT_fchecking_ = 1014,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1015,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1016,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1017,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1018,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1019,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1020,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1021,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1022,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1023,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1024,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1025,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1026,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1027,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1028,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1029,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1030,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1031,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1032,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1033, */                /* -fcilkplus */
  OPT_fcoarray_ = 1034,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1035,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1036,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1037,                        /* -fcommon */
  OPT_fcompare_debug = 1038,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1039,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1040,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1041,                  /* -fcompare-elim */
  OPT_fconcepts = 1042,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1043,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1044,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1045,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1046, */          /* -fconserve-space */
  OPT_fconserve_stack = 1047,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1048,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1049,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1050,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1051,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1052,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1053,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1054,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1055,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1056,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1057,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1058,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1059,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1060, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1061,                     /* -fcontracts */
  OPT_fconvert_ = 1062,                      /* -fconvert= */
  OPT_fcoroutines = 1063,                    /* -fcoroutines */
  OPT_fcpp = 1064,                           /* -fcpp */
  OPT_fcpp_begin = 1065,                     /* -fcpp-begin */
  OPT_fcpp_end = 1066,                       /* -fcpp-end */
  OPT_fcprop_registers = 1067,               /* -fcprop-registers */
  OPT_fcray_pointer = 1068,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1069,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1070,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1071, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1072,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1073,              /* -fcx-limited-range */
  OPT_fd = 1074,                             /* -fd */
  OPT_fd_lines_as_code = 1075,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1076,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1077,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1078,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1079,                      /* -fdbg-cnt= */
  OPT_fdce = 1080,                           /* -fdce */
  OPT_fdebug = 1081,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1082,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1083,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1084,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1085,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1086,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1087,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1088,              /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 1089,           /* -fdebug-types-section */
  OPT_fdebug_ = 1090,                        /* -fdebug= */
  OPT_fdec = 1091,                           /* -fdec */
  OPT_fdec_blank_format_item = 1092,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1093,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1094,           /* -fdec-format-defaults */
  OPT_fdec_include = 1095,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1096,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1097,                      /* -fdec-math */
  OPT_fdec_static = 1098,                    /* -fdec-static */
  OPT_fdec_structure = 1099,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1100,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1101, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1102,                          /* -fdef= */
  OPT_fdefault_double_8 = 1103,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1104, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1105,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1106,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1107,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1108,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1109,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1110,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1111,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1112,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1113,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1114,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1115,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1116, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1117,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1118,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1119,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1120,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1121,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1122,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1123,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1124,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1125,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1126,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1127,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1128,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1129,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1130, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1131,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1132,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1133,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1134,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1135,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1136,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1137,               /* -fdirectives-only */
  OPT_fdisable_ = 1138,                      /* -fdisable- */
  OPT_fdoc = 1139,                           /* -fdoc */
  OPT_fdoc_dir_ = 1140,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1141,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1142,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1143,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1144,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1145,                      /* -fdruntime */
  OPT_fdse = 1146,                           /* -fdse */
  OPT_fdump_ = 1147,                         /* -fdump- */
  OPT_fdump_ada_spec = 1148,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1149,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1150,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1151,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1152,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1153,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1154,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1155,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1156,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1157,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1158,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1159,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1160,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1161,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1162,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1163,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1164,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1165, */               /* -fdump-core */
  OPT_fdump_d_original = 1166,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1167,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1168,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1169,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1170,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1171,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1172,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1173,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1174,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1175, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1176,                   /* -fdump-passes */
  OPT_fdump_scos = 1177,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1178,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1179,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1180,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1181,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1182,                /* -fearly-inlining */
  OPT_felide_constructors = 1183,            /* -felide-constructors */
  OPT_felide_type = 1184,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1185, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1186,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1187,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1188,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1189,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1190,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1191,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1192,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1193,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1194,                /* -fenum-int-equiv */
  OPT_fexceptions = 1195,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1196,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1197,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1198,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1199,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1200,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1201,               /* -fextended-opaque */
  OPT_fextern_std_ = 1202,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1203,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1204,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1205,            /* -fexternal-templates */
  OPT_ff2c = 1206,                           /* -ff2c */
  OPT_ffast_math = 1207,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1208,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1209,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1210,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1211,              /* -ffinite-math-only */
  OPT_ffixed_ = 1212,                        /* -ffixed- */
  OPT_ffixed_form = 1213,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1214,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1215,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1216,                   /* -ffloat-store */
  OPT_ffloatvalue = 1217,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1218,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1219,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1220, */              /* -fforce-addr */
  OPT_fforward_propagate = 1221,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1222,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1223,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1224,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1225,                     /* -ffpe-trap= */
  OPT_ffree_form = 1226,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1227,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1228,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1229,                  /* -ffreestanding */
  OPT_ffriend_injection = 1230,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1231,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1232,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1233,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1234,             /* -ffunction-sections */
  OPT_fgcse = 1235,                          /* -fgcse */
  OPT_fgcse_after_reload = 1236,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1237,                      /* -fgcse-las */
  OPT_fgcse_lm = 1238,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1239,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1240,              /* -fgen-module-list= */
  OPT_fgimple = 1241,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1242,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1243,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1244,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1245,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1246,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1247,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1248,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1249,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1250,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1251,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1252,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1253,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1254,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1255,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1256,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1257,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1258,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1259,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1260,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1261,                      /* -fgraphite */
  OPT_fgraphite_identity = 1262,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1263,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1264,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1265, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1266,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1267,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1268, */                    /* -fhelp */
  /* OPT_fhelp_ = 1269, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1270,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1271,                     /* -fhonor-std */
  OPT_fhosted = 1272,                        /* -fhosted */
  OPT_fhuge_objects = 1273,                  /* -fhuge-objects */
  OPT_fident = 1274,                         /* -fident */
  OPT_fif_conversion = 1275,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1276,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1277,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1278,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1279,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1280,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1281,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1282,            /* -fimplicit-templates */
  OPT_findex = 1283,                         /* -findex */
  OPT_findirect_inlining = 1284,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1285,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1286,               /* -finit-character= */
  OPT_finit_derived = 1287,                  /* -finit-derived */
  OPT_finit_integer_ = 1288,                 /* -finit-integer= */
  OPT_finit_local_zero = 1289,               /* -finit-local-zero */
  OPT_finit_logical_ = 1290,                 /* -finit-logical= */
  OPT_finit_real_ = 1291,                    /* -finit-real= */
  OPT_finline = 1292,                        /* -finline */
  OPT_finline_arg_packing = 1293,            /* -finline-arg-packing */
  OPT_finline_atomics = 1294,                /* -finline-atomics */
  OPT_finline_functions = 1295,              /* -finline-functions */
  OPT_finline_functions_called_once = 1296,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1297, */           /* -finline-limit- */
  OPT_finline_limit_ = 1298,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1299,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1300,        /* -finline-small-functions */
  OPT_finput_charset_ = 1301,                /* -finput-charset= */
  OPT_finstrument_functions = 1302,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1303,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1304,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1305,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1306,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1307,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1308,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1309,                    /* -finvariants */
  OPT_fipa_bit_cp = 1310,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1311,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1312, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1313,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1314,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1315,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1316,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1317, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1318,                    /* -fipa-modref */
  OPT_fipa_profile = 1319,                   /* -fipa-profile */
  OPT_fipa_pta = 1320,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1321,                /* -fipa-pure-const */
  OPT_fipa_ra = 1322,                        /* -fipa-ra */
  OPT_fipa_reference = 1323,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1324,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1325,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1326,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1327,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1328, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1329,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1330,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1331,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1332,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1333,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1334,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1335,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1336,                  /* -fira-verbose= */
  OPT_fiso = 1337,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1338,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1339,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1340,              /* -fivar-visibility= */
  OPT_fivopts = 1341,                        /* -fivopts */
  OPT_fjump_tables = 1342,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1343,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1344,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1345,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1346,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1347,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1348,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1349,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1350,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1351,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1352,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1353,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1354,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1355,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1356,            /* -fleading-underscore */
  OPT_flibs_ = 1357,                         /* -flibs= */
  OPT_flifetime_dse = 1358,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1359,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1360,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1361,                /* -flinker-output= */
  /* OPT_flive_patching = 1362, */           /* -flive-patching */
  OPT_flive_patching_ = 1363,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1364,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1365,                   /* -flocal-ivars */
  OPT_flocation_ = 1366,                     /* -flocation= */
  /* OPT_floop_block = 1367, */              /* -floop-block */
  /* OPT_floop_flatten = 1368, */            /* -floop-flatten */
  OPT_floop_interchange = 1369,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1370,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1371, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1372,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1373, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1374,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1375,                     /* -flra-remat */
  OPT_flto = 1376,                           /* -flto */
  OPT_flto_compression_level_ = 1377,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1378, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1379,                /* -flto-partition= */
  OPT_flto_report = 1380,                    /* -flto-report */
  OPT_flto_report_wpa = 1381,                /* -flto-report-wpa */
  OPT_flto_ = 1382,                          /* -flto= */
  OPT_fltrans = 1383,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1384,           /* -fltrans-output-list= */
  OPT_fm2_g = 1385,                          /* -fm2-g */
  OPT_fm2_lower_case = 1386,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1387,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1388,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1389,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1390,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1391,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1392,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1393,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1394,             /* -fmacro-prefix-map= */
  OPT_fmain = 1395,                          /* -fmain */
  OPT_fmath_errno = 1396,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1397,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1398,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1399,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1400,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1401,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1402,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1403,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1404,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1405,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1406,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1407,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1408,               /* -fmessage-length= */
  OPT_fmod_ = 1409,                          /* -fmod= */
  OPT_fmodule_file_ = 1410,                  /* -fmodule-file= */
  OPT_fmodule_header = 1411,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1412,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1413,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1414,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1415,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1416,                   /* -fmodule-only */
  OPT_fmodule_private = 1417,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1418,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1419,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1420,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1421,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1422,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1423,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1424,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1425,                 /* -fms-extensions */
  OPT_fmudflap = 1426,                       /* -fmudflap */
  OPT_fmudflapir = 1427,                     /* -fmudflapir */
  OPT_fmudflapth = 1428,                     /* -fmudflapth */
  OPT_fmultiflags = 1429,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1430,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1431,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1432,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1433,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1434,                  /* -fnext-runtime */
  OPT_fnil = 1435,                           /* -fnil */
  OPT_fnil_receivers = 1436,                 /* -fnil-receivers */
  OPT_fno_modules = 1437,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1438,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1439,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1440,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1441,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1442,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1443,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1444,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1445,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1446,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1447,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1448,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1449,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1450,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1451,              /* -foffload-options= */
  OPT_foffload_ = 1452,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1453,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1454,                         /* -fonly= */
  OPT_fopenacc = 1455,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1456,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1457,                        /* -fopenmp */
  OPT_fopenmp_simd = 1458,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1459, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1460,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1461,                /* -foperator-names */
  OPT_fopt_info = 1462,                      /* -fopt-info */
  OPT_fopt_info_ = 1463,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1464, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1465,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1466,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1467, */          /* -foptional-diags */
  OPT_fpack_derived = 1468,                  /* -fpack-derived */
  OPT_fpack_struct = 1469,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1470,                  /* -fpack-struct= */
  OPT_fpad_source = 1471,                    /* -fpad-source */
  OPT_fpartial_inlining = 1472,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1473,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1474,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1475,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1476,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1477,                    /* -fpeel-loops */
  OPT_fpeephole = 1478,                      /* -fpeephole */
  OPT_fpeephole2 = 1479,                     /* -fpeephole2 */
  OPT_fpermissive = 1480,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1481,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1482,                           /* -fpic */
  OPT_fpie = 1483,                           /* -fpie */
  OPT_fpim = 1484,                           /* -fpim */
  OPT_fpim2 = 1485,                          /* -fpim2 */
  OPT_fpim3 = 1486,                          /* -fpim3 */
  OPT_fpim4 = 1487,                          /* -fpim4 */
  OPT_fplan9_extensions = 1488,              /* -fplan9-extensions */
  OPT_fplt = 1489,                           /* -fplt */
  OPT_fplugin_arg_ = 1490,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1491,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1492,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1493,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1494,                /* -fpostconditions */
  OPT_fpre_include_ = 1495,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1496,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1497,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1498,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1499,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1500,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1501,              /* -fpretty-templates */
  OPT_fpreview_all = 1502,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1503,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1504,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1505,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1506,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1507,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1508,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1509,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1510,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1511,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1512,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1513,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1514,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1515,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1516,           /* -fprintf-return-value */
  OPT_fprofile = 1517,                       /* -fprofile */
  OPT_fprofile_abs_path = 1518,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1519,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1520,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1521,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1522,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1523,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1524,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1525,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1526,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1527,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1528,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1529,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1530,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1531,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1532,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1533,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1534,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1535,               /* -fprofile-update= */
  OPT_fprofile_use = 1536,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1537,                  /* -fprofile-use= */
  OPT_fprofile_values = 1538,                /* -fprofile-values */
  OPT_fprotect_parens = 1539,                /* -fprotect-parens */
  OPT_fpthread = 1540,                       /* -fpthread */
  OPT_fq = 1541,                             /* -fq */
  OPT_frandom_seed = 1542,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1543,                  /* -frandom-seed= */
  OPT_frange = 1544,                         /* -frange */
  OPT_frange_check = 1545,                   /* -frange-check */
  OPT_freal_4_real_10 = 1546,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1547,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1548,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1549,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1550,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1551,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1552,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1553,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1554,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1555,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1556,               /* -frecord-marker=8 */
  OPT_frecursive = 1557,                     /* -frecursive */
  OPT_free = 1558,                           /* -free */
  OPT_freg_struct_return = 1559,             /* -freg-struct-return */
  /* OPT_fregmove = 1560, */                 /* -fregmove */
  OPT_frelease = 1561,                       /* -frelease */
  OPT_frename_registers = 1562,              /* -frename-registers */
  OPT_freorder_blocks = 1563,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1564,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1565,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1566,             /* -freorder-functions */
  OPT_frepack_arrays = 1567,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1568,          /* -freplace-objc-classes */
  OPT_frepo = 1569,                          /* -frepo */
  OPT_freport_bug = 1570,                    /* -freport-bug */
  OPT_frequire_return_statement = 1571,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1572,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1573, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1574,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1575,                   /* -fresolution= */
  OPT_freturn = 1576,                        /* -freturn */
  OPT_frevert_all = 1577,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1578,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1579,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1580,             /* -frevert=intpromote */
  OPT_frounding_math = 1581,                 /* -frounding-math */
  OPT_frtti = 1582,                          /* -frtti */
  OPT_fruntime_modules_ = 1583,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1584,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1585,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1586,                   /* -frust-crate= */
  OPT_frust_debug = 1587,                    /* -frust-debug */
  OPT_frust_dump_ = 1588,                    /* -frust-dump- */
  OPT_frust_edition_ = 1589,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1590,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1591,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1592,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1593,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1594,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1595,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1596,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1597,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1598,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1599,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1600,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1601,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1602, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1603,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1604,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1605,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1606,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1607,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1608,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1609,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1610,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1611, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1612,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1613,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1614,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1615,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1616,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1617,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1618,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1619,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1620,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1621,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1622,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1623,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1624,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1625,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1626,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1627,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1628, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1629,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1630,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1631,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1632,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1633,               /* -fsection-anchors */
  /* OPT_fsee = 1634, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1635,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1636,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1637,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1638,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1639,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1640,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1641,        /* -fsemantic-interposition */
  OPT_fshared = 1642,                        /* -fshared */
  OPT_fshort_enums = 1643,                   /* -fshort-enums */
  OPT_fshort_wchar = 1644,                   /* -fshort-wchar */
  OPT_fshow_column = 1645,                   /* -fshow-column */
  OPT_fshrink_wrap = 1646,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1647,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1648,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1649,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1650,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1651,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1652,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1653,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1654,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1655,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1656,                /* -fsoft-check-all */
  OPT_fsources = 1657,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1658,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1659,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1660,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1661,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1662,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1663,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1664,                      /* -fsquangle */
  OPT_fssa_backprop = 1665,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1666,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1667,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1668,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1669, */             /* -fstack-check */
  OPT_fstack_check_ = 1670,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1671,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1672,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1673,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1674,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1675,               /* -fstack-protector */
  OPT_fstack_protector_all = 1676,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1677,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1678,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1679,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1680,                   /* -fstack-usage */
  OPT_fstats = 1681,                         /* -fstats */
  OPT_fstdarg_opt = 1682,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1683,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1684, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1685,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1686,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1687, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1688,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1689,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1690,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1691,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1692, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1693,            /* -fstrong-eval-order= */
  OPT_fswig = 1694,                          /* -fswig */
  OPT_fswitch_errors = 1695,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1696,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1697,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1698,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1699, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1700,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1701, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1702,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1703, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1704,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1705,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1706,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1707,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1708,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1709,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1710,                   /* -ftime-report */
  OPT_ftime_report_details = 1711,           /* -ftime-report-details */
  OPT_ftls_model_ = 1712,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1713,              /* -ftoplevel-reorder */
  OPT_ftracer = 1714,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1715,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1716,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1717,                   /* -ftrampolines */
  OPT_ftransition_all = 1718,                /* -ftransition=all */
  OPT_ftransition_field = 1719,              /* -ftransition=field */
  OPT_ftransition_in = 1720,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1721,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1722,          /* -ftransition=templates */
  OPT_ftransition_tls = 1723,                /* -ftransition=tls */
  OPT_ftrapping_math = 1724,                 /* -ftrapping-math */
  OPT_ftrapv = 1725,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1726,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1727,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1728,                      /* -ftree-ccp */
  OPT_ftree_ch = 1729,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1730, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1731,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1732,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1733, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1734,                   /* -ftree-cselim */
  OPT_ftree_dce = 1735,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1736,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1737,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1738,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1739,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1740, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1741,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1742,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1743, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1744,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1745,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1746, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1747,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1748,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1749,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1750,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1751,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1752,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1753,                      /* -ftree-pre */
  OPT_ftree_pta = 1754,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1755,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1756, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1757,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1758,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1759,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1760,                     /* -ftree-slsr */
  OPT_ftree_sra = 1761,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1762, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1763, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1764,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1765,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1766,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1767, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1768,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1769, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1770,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1771,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1772,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1773,         /* -funconstrained-commons */
  OPT_funderscoring = 1774,                  /* -funderscoring */
  OPT_funit_at_a_time = 1775,                /* -funit-at-a-time */
  OPT_funittest = 1776,                      /* -funittest */
  OPT_funreachable_traps = 1777,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1778,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1779,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1780,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1781, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1782,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1783,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1784,                 /* -funsigned-char */
  OPT_funswitch_loops = 1785,                /* -funswitch-loops */
  OPT_funwind_tables = 1786,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1787,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1788,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1789,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1790,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1791,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1792,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1793,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1794,                     /* -fuse-list= */
  OPT_fvar_tracking = 1795,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1796,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1797,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1798,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1799,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1800, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1801,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1802,                   /* -fverbose-asm */
  /* OPT_fversion = 1803, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1804,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1805,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1806,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1807,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1808,                   /* -fvisibility= */
  OPT_fvpt = 1809,                           /* -fvpt */
  OPT_fvtable_gc = 1810,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1811,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1812,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1813,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1814,                     /* -fvtv-debug */
  OPT_fweak = 1815,                          /* -fweak */
  OPT_fweak_templates = 1816,                /* -fweak-templates */
  OPT_fweb = 1817,                           /* -fweb */
  /* OPT_fwhole_file = 1818, */              /* -fwhole-file */
  OPT_fwhole_program = 1819,                 /* -fwhole-program */
  OPT_fwholediv = 1820,                      /* -fwholediv */
  OPT_fwholevalue = 1821,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1822,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1823,             /* -fworking-directory */
  OPT_fwpa = 1824,                           /* -fwpa */
  OPT_fwpa_ = 1825,                          /* -fwpa= */
  OPT_fwrapv = 1826,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1827,                 /* -fwrapv-pointer */
  OPT_fxref = 1828,                          /* -fxref */
  /* OPT_fzee = 1829, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1830,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1831,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1832,                     /* -fzero-link */
  OPT_g = 1833,                              /* -g */
  OPT_gant = 1834,                           /* -gant */
  OPT_gas_loc_support = 1835,                /* -gas-loc-support */
  OPT_gas_locview_support = 1836,            /* -gas-locview-support */
  OPT_gbtf = 1837,                           /* -gbtf */
  OPT_gcoff = 1838,                          /* -gcoff */
  OPT_gcoff1 = 1839,                         /* -gcoff1 */
  OPT_gcoff2 = 1840,                         /* -gcoff2 */
  OPT_gcoff3 = 1841,                         /* -gcoff3 */
  OPT_gcolumn_info = 1842,                   /* -gcolumn-info */
  OPT_gctf = 1843,                           /* -gctf */
  OPT_gdescribe_dies = 1844,                 /* -gdescribe-dies */
  OPT_gdwarf = 1845,                         /* -gdwarf */
  OPT_gdwarf_ = 1846,                        /* -gdwarf- */
  OPT_gdwarf32 = 1847,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1848,                       /* -gdwarf64 */
  OPT_gen_decls = 1849,                      /* -gen-decls */
  OPT_ggdb = 1850,                           /* -ggdb */
  OPT_ggnu_pubnames = 1851,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1852,                   /* -gimple-stats */
  OPT_ginline_points = 1853,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1854, /* -ginternal-reset-location-views */
  OPT_gnat = 1855,                           /* -gnat */
  OPT_gnatO = 1856,                          /* -gnatO */
  OPT_gno_ = 1857,                           /* -gno- */
  OPT_gno_pubnames = 1858,                   /* -gno-pubnames */
  OPT_gpubnames = 1859,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1860,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1861,                   /* -gsplit-dwarf */
  OPT_gstabs = 1862,                         /* -gstabs */
  OPT_gstabs_ = 1863,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1864,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1865,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1866,                        /* -gtoggle */
  OPT_gvariable_location_views = 1867,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1868,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1869,                           /* -gvms */
  OPT_gxcoff = 1870,                         /* -gxcoff */
  OPT_gxcoff_ = 1871,                        /* -gxcoff+ */
  OPT_gz = 1872,                             /* -gz */
  OPT_gz_ = 1873,                            /* -gz= */
  OPT_h = 1874,                              /* -h */
  OPT_help = 1875,                           /* -help */
  OPT_idirafter = 1876,                      /* -idirafter */
  OPT_imacros = 1877,                        /* -imacros */
  OPT_imultiarch = 1878,                     /* -imultiarch */
  OPT_imultilib = 1879,                      /* -imultilib */
  OPT_include = 1880,                        /* -include */
  OPT_iplugindir_ = 1881,                    /* -iplugindir= */
  OPT_iprefix = 1882,                        /* -iprefix */
  OPT_iquote = 1883,                         /* -iquote */
  OPT_isysroot = 1884,                       /* -isysroot */
  OPT_isystem = 1885,                        /* -isystem */
  OPT_iwithprefix = 1886,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1887,              /* -iwithprefixbefore */
  OPT_k8 = 1888,                             /* -k8 */
  OPT_l = 1889,                              /* -l */
  OPT_lang_asm = 1890,                       /* -lang-asm */
  OPT_list = 1891,                           /* -list */
  OPT_m128bit_long_double = 1892,            /* -m128bit-long-double */
  OPT_m16 = 1893,                            /* -m16 */
  OPT_m32 = 1894,                            /* -m32 */
  OPT_m3dnow = 1895,                         /* -m3dnow */
  OPT_m3dnowa = 1896,                        /* -m3dnowa */
  OPT_m64 = 1897,                            /* -m64 */
  OPT_m80387 = 1898,                         /* -m80387 */
  OPT_m8bit_idiv = 1899,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1900,             /* -m96bit-long-double */
  OPT_mabi_ = 1901,                          /* -mabi= */
  OPT_mabm = 1902,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1903,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1904,                 /* -maddress-mode= */
  OPT_madx = 1905,                           /* -madx */
  OPT_maes = 1906,                           /* -maes */
  OPT_malign_data_ = 1907,                   /* -malign-data= */
  OPT_malign_double = 1908,                  /* -malign-double */
  OPT_malign_functions_ = 1909,              /* -malign-functions= */
  OPT_malign_jumps_ = 1910,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1911,                  /* -malign-loops= */
  OPT_malign_stringops = 1912,               /* -malign-stringops */
  OPT_mamx_bf16 = 1913,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1914,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1915,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1916,                      /* -mamx-int8 */
  OPT_mamx_tile = 1917,                      /* -mamx-tile */
  OPT_mandroid = 1918,                       /* -mandroid */
  OPT_march_ = 1919,                         /* -march= */
  OPT_masm_ = 1920,                          /* -masm= */
  OPT_mavx = 1921,                           /* -mavx */
  OPT_mavx2 = 1922,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1923,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1924,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1925,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1926,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1927,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1928,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1929,                      /* -mavx512bw */
  OPT_mavx512cd = 1930,                      /* -mavx512cd */
  OPT_mavx512dq = 1931,                      /* -mavx512dq */
  OPT_mavx512er = 1932,                      /* -mavx512er */
  OPT_mavx512f = 1933,                       /* -mavx512f */
  OPT_mavx512fp16 = 1934,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1935,                    /* -mavx512ifma */
  OPT_mavx512pf = 1936,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1937,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1938,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1939,                      /* -mavx512vl */
  OPT_mavx512vnni = 1940,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1941,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1942,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1943,                       /* -mavxifma */
  OPT_mavxneconvert = 1944,                  /* -mavxneconvert */
  OPT_mavxvnni = 1945,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1946,                   /* -mavxvnniint8 */
  OPT_mbionic = 1947,                        /* -mbionic */
  OPT_mbmi = 1948,                           /* -mbmi */
  OPT_mbmi2 = 1949,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1950,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1951,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1952,                    /* -mcet-switch */
  OPT_mcld = 1953,                           /* -mcld */
  OPT_mcldemote = 1954,                      /* -mcldemote */
  OPT_mclflushopt = 1955,                    /* -mclflushopt */
  OPT_mclwb = 1956,                          /* -mclwb */
  OPT_mclzero = 1957,                        /* -mclzero */
  OPT_mcmodel_ = 1958,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1959,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 1960, */                    /* -mcpu= */
  OPT_mcrc32 = 1961,                         /* -mcrc32 */
  OPT_mcx16 = 1962,                          /* -mcx16 */
  OPT_mdaz_ftz = 1963,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1964,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1965,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1966,            /* -mdump-tune-features */
  OPT_menqcmd = 1967,                        /* -menqcmd */
  OPT_mf16c = 1968,                          /* -mf16c */
  OPT_mfancy_math_387 = 1969,                /* -mfancy-math-387 */
  OPT_mfentry = 1970,                        /* -mfentry */
  OPT_mfentry_name_ = 1971,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1972,               /* -mfentry-section= */
  OPT_mfma = 1973,                           /* -mfma */
  OPT_mfma4 = 1974,                          /* -mfma4 */
  OPT_mforce_drap = 1975,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1976,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1977,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1978,                       /* -mfpmath= */
  OPT_mfsgsbase = 1979,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1980,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1981, */              /* -mfused-madd */
  OPT_mfxsr = 1982,                          /* -mfxsr */
  /* OPT_mgather = 1983, */                  /* -mgather */
  OPT_mgeneral_regs_only = 1984,             /* -mgeneral-regs-only */
  OPT_mgfni = 1985,                          /* -mgfni */
  OPT_mglibc = 1986,                         /* -mglibc */
  OPT_mhard_float = 1987,                    /* -mhard-float */
  OPT_mharden_sls_ = 1988,                   /* -mharden-sls= */
  OPT_mhle = 1989,                           /* -mhle */
  OPT_mhreset = 1990,                        /* -mhreset */
  OPT_miamcu = 1991,                         /* -miamcu */
  OPT_mieee_fp = 1992,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1993,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1994,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1995,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1996,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1997,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1998,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1999,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2000, */            /* -mintel-syntax */
  OPT_mkl = 2001,                            /* -mkl */
  OPT_mlam_ = 2002,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2003,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2004,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2005,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2006,                /* -mlong-double-80 */
  OPT_mlwp = 2007,                           /* -mlwp */
  OPT_mlzcnt = 2008,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2009,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2010,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2011,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2012,                  /* -mmitigate-rop */
  OPT_mmmx = 2013,                           /* -mmmx */
  OPT_mmovbe = 2014,                         /* -mmovbe */
  OPT_mmovdir64b = 2015,                     /* -mmovdir64b */
  OPT_mmovdiri = 2016,                       /* -mmovdiri */
  OPT_mmove_max_ = 2017,                     /* -mmove-max= */
  OPT_mmpx = 2018,                           /* -mmpx */
  OPT_mms_bitfields = 2019,                  /* -mms-bitfields */
  OPT_mmusl = 2020,                          /* -mmusl */
  OPT_mmwait = 2021,                         /* -mmwait */
  OPT_mmwaitx = 2022,                        /* -mmwaitx */
  OPT_mneeded = 2023,                        /* -mneeded */
  OPT_mno_align_stringops = 2024,            /* -mno-align-stringops */
  OPT_mno_default = 2025,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2026,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2027,                  /* -mno-push-args */
  OPT_mno_red_zone = 2028,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2029,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2030,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2031,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2032,                          /* -mpc32 */
  OPT_mpc64 = 2033,                          /* -mpc64 */
  OPT_mpc80 = 2034,                          /* -mpc80 */
  OPT_mpclmul = 2035,                        /* -mpclmul */
  OPT_mpcommit = 2036,                       /* -mpcommit */
  OPT_mpconfig = 2037,                       /* -mpconfig */
  OPT_mpku = 2038,                           /* -mpku */
  OPT_mpopcnt = 2039,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2040, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2041,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2042,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2043,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2044,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2045,                        /* -mprfchw */
  OPT_mptwrite = 2046,                       /* -mptwrite */
  OPT_mpush_args = 2047,                     /* -mpush-args */
  OPT_mraoint = 2048,                        /* -mraoint */
  OPT_mrdpid = 2049,                         /* -mrdpid */
  OPT_mrdrnd = 2050,                         /* -mrdrnd */
  OPT_mrdseed = 2051,                        /* -mrdseed */
  OPT_mrecip = 2052,                         /* -mrecip */
  OPT_mrecip_ = 2053,                        /* -mrecip= */
  OPT_mrecord_mcount = 2054,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2055,                 /* -mrecord-return */
  OPT_mred_zone = 2056,                      /* -mred-zone */
  OPT_mregparm_ = 2057,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2058,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2059,                           /* -mrtd */
  OPT_mrtm = 2060,                           /* -mrtm */
  OPT_msahf = 2061,                          /* -msahf */
  /* OPT_mscatter = 2062, */                 /* -mscatter */
  OPT_mserialize = 2063,                     /* -mserialize */
  OPT_msgx = 2064,                           /* -msgx */
  OPT_msha = 2065,                           /* -msha */
  OPT_mshstk = 2066,                         /* -mshstk */
  OPT_mskip_rax_setup = 2067,                /* -mskip-rax-setup */
  OPT_msoft_float = 2068,                    /* -msoft-float */
  OPT_msse = 2069,                           /* -msse */
  OPT_msse2 = 2070,                          /* -msse2 */
  OPT_msse2avx = 2071,                       /* -msse2avx */
  OPT_msse3 = 2072,                          /* -msse3 */
  OPT_msse4 = 2073,                          /* -msse4 */
  OPT_msse4_1 = 2074,                        /* -msse4.1 */
  OPT_msse4_2 = 2075,                        /* -msse4.2 */
  OPT_msse4a = 2076,                         /* -msse4a */
  /* OPT_msse5 = 2077, */                    /* -msse5 */
  OPT_msseregparm = 2078,                    /* -msseregparm */
  OPT_mssse3 = 2079,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2080,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2081, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2082,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2083, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2084,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2085,                  /* -mstackrealign */
  OPT_mstore_max_ = 2086,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2087,            /* -mstringop-strategy= */
  OPT_mstv = 2088,                           /* -mstv */
  OPT_mtbm = 2089,                           /* -mtbm */
  OPT_mtls_dialect_ = 2090,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2091,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2092,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2093,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2094,                         /* -mtune= */
  OPT_muclibc = 2095,                        /* -muclibc */
  OPT_muintr = 2096,                         /* -muintr */
  OPT_munroll_only_small_loops = 2097,       /* -munroll-only-small-loops */
  OPT_mvaes = 2098,                          /* -mvaes */
  OPT_mveclibabi_ = 2099,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2100,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2101,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2102,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2103,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2104,                      /* -mwbnoinvd */
  OPT_mwidekl = 2105,                        /* -mwidekl */
  OPT_mx32 = 2106,                           /* -mx32 */
  OPT_mxop = 2107,                           /* -mxop */
  OPT_mxsave = 2108,                         /* -mxsave */
  OPT_mxsavec = 2109,                        /* -mxsavec */
  OPT_mxsaveopt = 2110,                      /* -mxsaveopt */
  OPT_mxsaves = 2111,                        /* -mxsaves */
  OPT_n = 2112,                              /* -n */
  OPT_name_sort = 2113,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2114,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2115,              /* -no-integrated-cpp */
  OPT_no_pie = 2116,                         /* -no-pie */
  OPT_nocpp = 2117,                          /* -nocpp */
  OPT_nodefaultlibs = 2118,                  /* -nodefaultlibs */
  OPT_nolibc = 2119,                         /* -nolibc */
  OPT_nophoboslib = 2120,                    /* -nophoboslib */
  OPT_nostartfiles = 2121,                   /* -nostartfiles */
  OPT_nostdinc = 2122,                       /* -nostdinc */
  OPT_nostdinc__ = 2123,                     /* -nostdinc++ */
  OPT_nostdlib = 2124,                       /* -nostdlib */
  OPT_nostdlib__ = 2125,                     /* -nostdlib++ */
  OPT_o = 2126,                              /* -o */
  OPT_objects = 2127,                        /* -objects */
  OPT_p = 2128,                              /* -p */
  OPT_pass_exit_codes = 2129,                /* -pass-exit-codes */
  /* OPT_pedantic = 2130, */                 /* -pedantic */
  OPT_pedantic_errors = 2131,                /* -pedantic-errors */
  OPT_pg = 2132,                             /* -pg */
  OPT_pie = 2133,                            /* -pie */
  OPT_pipe = 2134,                           /* -pipe */
  OPT_posix = 2135,                          /* -posix */
  OPT_print_file_name_ = 2136,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2137,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2138,          /* -print-multi-directory */
  OPT_print_multi_lib = 2139,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2140,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2141,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2142,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2143,               /* -print-prog-name= */
  OPT_print_search_dirs = 2144,              /* -print-search-dirs */
  OPT_print_sysroot = 2145,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2146,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2147,                    /* -print-value */
  OPT_profile = 2148,                        /* -profile */
  OPT_pthread = 2149,                        /* -pthread */
  OPT_quiet = 2150,                          /* -quiet */
  OPT_r = 2151,                              /* -r */
  OPT_rdynamic = 2152,                       /* -rdynamic */
  OPT_remap = 2153,                          /* -remap */
  OPT_reverse_sort = 2154,                   /* -reverse-sort */
  OPT_s = 2155,                              /* -s */
  OPT_save_temps = 2156,                     /* -save-temps */
  OPT_save_temps_ = 2157,                    /* -save-temps= */
  OPT_shared = 2158,                         /* -shared */
  OPT_shared_libgcc = 2159,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2160,               /* -shared-libphobos */
  OPT_size_sort = 2161,                      /* -size-sort */
  /* OPT_specs = 2162, */                    /* -specs */
  OPT_specs_ = 2163,                         /* -specs= */
  OPT_static = 2164,                         /* -static */
  OPT_static_libasan = 2165,                 /* -static-libasan */
  OPT_static_libgcc = 2166,                  /* -static-libgcc */
  OPT_static_libgfortran = 2167,             /* -static-libgfortran */
  OPT_static_libgm2 = 2168,                  /* -static-libgm2 */
  OPT_static_libgo = 2169,                   /* -static-libgo */
  OPT_static_libhwasan = 2170,               /* -static-libhwasan */
  OPT_static_liblsan = 2171,                 /* -static-liblsan */
  OPT_static_libmpx = 2172,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2173,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2174,               /* -static-libphobos */
  OPT_static_libquadmath = 2175,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2176,               /* -static-libstdc++ */
  OPT_static_libtsan = 2177,                 /* -static-libtsan */
  OPT_static_libubsan = 2178,                /* -static-libubsan */
  OPT_static_pie = 2179,                     /* -static-pie */
  /* OPT_std_c__03 = 2180, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2181, */                /* -std=c++0x */
  OPT_std_c__11 = 2182,                      /* -std=c++11 */
  OPT_std_c__14 = 2183,                      /* -std=c++14 */
  OPT_std_c__17 = 2184,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2185, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2186, */                /* -std=c++1z */
  OPT_std_c__20 = 2187,                      /* -std=c++20 */
  OPT_std_c__23 = 2188,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2189, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2190, */                /* -std=c++2b */
  OPT_std_c__98 = 2191,                      /* -std=c++98 */
  OPT_std_c11 = 2192,                        /* -std=c11 */
  OPT_std_c17 = 2193,                        /* -std=c17 */
  /* OPT_std_c18 = 2194, */                  /* -std=c18 */
  /* OPT_std_c1x = 2195, */                  /* -std=c1x */
  OPT_std_c2x = 2196,                        /* -std=c2x */
  /* OPT_std_c89 = 2197, */                  /* -std=c89 */
  OPT_std_c90 = 2198,                        /* -std=c90 */
  OPT_std_c99 = 2199,                        /* -std=c99 */
  /* OPT_std_c9x = 2200, */                  /* -std=c9x */
  OPT_std_f2003 = 2201,                      /* -std=f2003 */
  OPT_std_f2008 = 2202,                      /* -std=f2008 */
  OPT_std_f2008ts = 2203,                    /* -std=f2008ts */
  OPT_std_f2018 = 2204,                      /* -std=f2018 */
  OPT_std_f95 = 2205,                        /* -std=f95 */
  OPT_std_gnu = 2206,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2207, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2208, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2209,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2210,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2211,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2212, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2213, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2214,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2215,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2216, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2217, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2218,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2219,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2220,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2221, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2222, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2223,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2224, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2225,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2226,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2227, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2228, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2229,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2230, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2231, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2232, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2233, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2234, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2235,                     /* -std=legacy */
  OPT_stdlib_ = 2236,                        /* -stdlib= */
  OPT_symbol_ = 2237,                        /* -symbol= */
  OPT_symbolic = 2238,                       /* -symbolic */
  OPT_t = 2239,                              /* -t */
  OPT_time = 2240,                           /* -time */
  OPT_time_ = 2241,                          /* -time= */
  OPT_tno_android_cc = 2242,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2243,                 /* -tno-android-ld */
  OPT_traditional = 2244,                    /* -traditional */
  OPT_traditional_cpp = 2245,                /* -traditional-cpp */
  OPT_tree_stats = 2246,                     /* -tree-stats */
  OPT_trigraphs = 2247,                      /* -trigraphs */
  OPT_type_stats = 2248,                     /* -type-stats */
  OPT_u = 2249,                              /* -u */
  OPT_undef = 2250,                          /* -undef */
  OPT_v = 2251,                              /* -v */
  OPT_version = 2252,                        /* -version */
  OPT_w = 2253,                              /* -w */
  OPT_wrapper = 2254,                        /* -wrapper */
  OPT_x = 2255,                              /* -x */
  OPT_z = 2256,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
