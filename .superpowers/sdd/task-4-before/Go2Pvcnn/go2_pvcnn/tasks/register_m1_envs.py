...
from go2_pvcnn.tasks.m1_smoke_env_cfg import M1SmokeEnvCfg
from go2_pvcnn.tasks.m1_roll_env_cfg import M1RollEnvCfg
from go2_pvcnn.tasks.m1_walk_env_cfg import M1WalkEnvCfg
from go2_pvcnn.tasks.m1_wave_env_cfg import M1WaveFlatEnvCfg
from go2_pvcnn.tasks.m1_small_obstacle_env_cfg import (
    M1SmallObstacle10mmEnvCfg,
    M1SmallObstacle5mmEnvCfg,
    M1SmallObstacleEnvCfg,
)
from go2_pvcnn.tasks.m1_pvcnn_small_obstacle_env_cfg import (
    M1PvcnnCrossing100mmEnvCfg,
    M1PvcnnCrossing60mmEnvCfg,
    M1PvcnnCrossing60mmDistilledPlayEnvCfg,
    M1PvcnnCrossing60mmContactFreePlayEnvCfg,
    M1PvcnnCrossing60mmContactFreeTrainEnvCfg,
    M1PvcnnCrossing60mmPairCurriculumEnvCfg,
    M1PvcnnCrossing60mmPolicyPlayEnvCfg,
    M1PvcnnCrossing60mmGuidedEnvCfg,
    M1PvcnnCrossing60mmGuidedFixedEnvCfg,
    M1PvcnnCrossing60mmPlayEnvCfg,
    M1PvcnnCrossing60mmUnlockedEnvCfg,
    M1PvcnnFlatSmallAvoidanceEnvCfg,
    M1PvcnnFlatSmallAvoidanceEnvCfg_PLAY,
)
...
gym.register(
    ...
    kwargs={"env_cfg_entry_point": M1PvcnnCrossing60mmEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnCrossing60mmPlayEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnCrossing60mmUnlockedEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnCrossing60mmGuidedEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmGuidedFixedEnvCfg,
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmDistilledPlayEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmContactFreeTrainEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmContactFreePlayEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmPairCurriculumEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1PvcnnCrossing60mmPolicyPlayEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnCrossing100mmEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnFlatSmallAvoidanceEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1PvcnnFlatSmallAvoidanceEnvCfg_PLAY, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1SmokeEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1SmallObstacle5mmEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": M1SmallObstacle10mmEnvCfg, "rsl_rl_cfg_entry_point": None},
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1WalkEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1RollEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1WaveFlatEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": M1SmallObstacleEnvCfg,
        "rsl_rl_cfg_entry_point": None,
    },
)
